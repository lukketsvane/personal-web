...
image: "https://i.ibb.co/ZgBx1m5/bw-simple-1.png"
---
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/ZgBx1m5/bw-simple-1.png" alt="bw-simple-1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/6Zprp61/bw-simple-2.png" alt="bw-simple-2" style={{ width: '100%' }} />
  </div>
</div>

<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/KmsHPgc/bw-simple-3.png" alt="bw-simple-3" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/KD7WZHD/bw-simple-4.png" alt="bw-simple-4" style={{ width: '100%' }} />
  </div>
</div>
...
<div style={{ textAlign: 'center', margin: '20px 0' }}>
  <img src="https://i.ibb.co/2v9QjQT/vera-molnar-interruptions.webp" alt="Vera Molnar's Work" style={{ width: '70%' }} />
  <p><em>Vera Molnar's discussion on generative art.</em></p>
</div>
...
<div style={{ textAlign: 'center', margin: '20px 0' }}>
  <img src="https://i.ibb.co/0VDKwfn/func-ran.png" alt="Uniform distribution of squares via the random() function." style={{ width: '70%' }} />
  <p><em>Uniform distribution of squares via the `random()` function.</em></p>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/TPqjkby/thunderstorm.png" alt="Thunderstorm" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/y87zZ3k/lava-lamp.png" alt="Lava Lamp" style={{ width: '100%' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/N6Vt1PY/func-spatter.png" alt="Distribution Sketch" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/N6Vt1PY/func-spatter.png" alt="Function Spatter" style={{ width: '100%' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/8s6fkr7/func-3.png" alt="Random Distribution" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/3TMYpM2/func-4.png" alt="Perlin Noise Distribution" style={{ width: '100%' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/LNJ4W0R/sol-lewitt-wall-drawing.png" alt="Sol LeWitt - Wall Drawing #118" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Sol LeWitt - Wall Drawing #118</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/wK1vzDn/sol-lewitt-proposal-for-wall-drawing.png" alt="Sol LeWitt - Proposal for Wall Drawing" style={{ width: '100%' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '33.33%', padding: '5px' }}>
    <img src="https://i.ibb.co/3NQRZL7/sol-lewitt-Interactive-wall-drawing.png" alt="Genuary Day 7 - Sol LeWitt Wall Drawing" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Genuary Day 7 - Sol LeWitt Wall Drawing</p>
  </div>
  <div style={{ width: '33.33%', padding: '5px' }}>
    <img src="https://i.ibb.co/nfZVmXh/sol-lewitt-drawing-being-made-at-dia-beacon.png" alt="Sol LeWitt drawing being made at Dia Beacon" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Sol LeWitt drawing being made at Dia Beacon</p>
  </div>
  <div style={{ width: '33.33%', padding: '5px' }}>
    <img src="https://i.ibb.co/Mgvr9QP/sol-lewitt-wall-drawing-interactive.jpg" alt="Interactive Sol LeWitt Wall Drawing" style={{ width: '100%', marginBottom: '10px' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', marginTop: '20px' }}>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="https://i.ibb.co/jwn5Jxd/conway-1.gif" alt="3 phase pulsar" style={{ width: '100%' }} />
    <p>3 phase pulsar</p>
  </div>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="https://i.ibb.co/b3MTVXk/conway-2.gif" alt="Finite pattern" style={{ width: '100%' }} />
    <p>Finite pattern</p>
  </div>
  <div style={{ width: '30%', padding: '5px' }}>
    <img src="https://i.ibb.co/34xTdBK/conway-3.gif" alt="Gliders" style={{ width: '100%' }} />
    <p>Gliders</p>
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/yNQKnyY/snowflake-1.png" alt="Snowflake 1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/JFxsWFQ/snowflake-2.png" alt="Snowflake 2" style={{ width: '100%' }} />
  </div>
</div>

## Cultivating Art

_Magical Contamination_ by Antoine Bridier-Nahmias turns petri dishes into canvases for microbial growth. Echoing the approach used in Gravner-Griffeath's snowflakes, the artist manipulates conditions such as oxygen levels, lighting, and temperature to influence mold development.
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/3yyNqJx/magical-contamination-1.png" alt="Magical Contamination 1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/cYVgjRR/magical-contamination-2.png" alt="Magical Contamination 2" style={{ width: '100%' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/2PfmBf2/reas-rgb-3-1.jpg" alt="Casey Reas RGB 3 1" style={{ width: '100%', marginBottom: '10px' }} />
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/jLkpLDP/reas-rgb-3-2.jpg" alt="Casey Reas RGB 3 2" style={{ width: '100%' }} />
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/3BWdV0J/flight-patterns.jpg" alt="Flight Patterns (2010) - Aaron Koblin" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Flight Patterns (2010) - Aaron Koblin</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/bHC2ts3/asphyxia.jpg" alt="Asphyxia (2015) - Maria Takeuchi , Frederico Phillips, performed by Shiho Tanaka" style={{ width: '100%' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/2v9QjQT/vera-molnar-interruptions.webp" alt="Windswept (2011) - Charles Sowers" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Windswept (2011) - Charles Sowers</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/2v9QjQT/vera-molnar-interruptions.webp" alt="Windswept (2011) - Charles Sowers" style={{ width: '100%' }} />
    <p>Windswept (2011) - Charles Sowers</p>
  </div>
</div>
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/ZKy9BvP/myriad-tulips.jpg" alt="Myriad (Tulips) (2018) - Anna Ridler" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Myriad (Tulips) (2018) - Anna Ridler</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/6rgRnz3/mosaic-virus.jpg" alt="Mosaic Virus (2019) - Anna Ridler" style={{ width: '100%' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/SR3Y9Xm/hilma-af-klint-the-five.png" alt="A collective automatic drawing by The Five, Hilma af Klint's spiritualist group" style={{ width: '100%', marginBottom: '10px' }} />
    <p>A collective automatic drawing by The Five, Hilma af Klint's spiritualist group</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/DYM1MBJ/the-smile-of-the-flamboyant-wings.png" alt="The Smile of the Flamboyant Wings (1953) - Joan Miró" style={{ width: '100%' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: '20px' }}>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/tHyQvcZ/paul-emile-borduas-untitled.webp" alt="Untitled (1954-55) - Paul Emile Borduas" style={{ width: '100%', marginBottom: '10px' }} />
    <p>Untitled (1954-55) - Paul Emile Borduas</p>
  </div>
  <div style={{ width: '50%', padding: '5px' }}>
    <img src="https://i.ibb.co/j86yY5h/max-ernst-forest-and-dove.jpg" alt="Forest and Dove (1927) - Max Ernst Uses grattage technique" style={{ width: '100%' }} />
...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', marginTop: '20px' }}>
  <div style={{ width: '80%', padding: '5px' }}>
    <img src="https://i.ibb.co/xDtV2Gk/jackson-pollock-alchemy.png" alt="Alchemy (1947) - Jackson Pollock" style={{ width: '100%', marginBottom: '10px' }} />
